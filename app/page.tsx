    ...
    <div className="flex flex-col flex-1">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="text-center lg:text-left">
              <p className="text-xs sm:text-sm uppercase tracking-[3px] font-semibold text-[#6C7087] mb-4" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
                Welcome To Zan Center
              </p>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-semibold leading-tight text-[#000000] mb-4 sm:mb-6" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
                Caring For You Before Problems Begin
              </h1>
              <p className="text-base sm:text-lg lg:text-xl text-[#000000] leading-relaxed mb-6 sm:mb-8" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-[#666666] max-w-2xl mx-auto" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-0">
            <div className="bg-[#F2F8F5] p-6 sm:p-8 text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-[#333333] mb-3" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
                Book Appointments
              </h3>
              <p className="text-sm text-[#666666]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-[#FCE7EC]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm sm:text-base text-[#666666] mb-6 sm:mb-8" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          <div className="flex items-center">
            <Image
              ...
              width={160}
              height={50}
              className="object-contain h-[40px] sm:h-[50px] w-auto"
            />
          </div>
          <p className="text-[#6C7087] text-xs sm:text-sm text-center sm:text-right" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
