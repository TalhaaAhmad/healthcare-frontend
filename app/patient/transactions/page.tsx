    ...
    <div className="space-y-6">
      <div className="bg-white border border-gray-100">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-100">
          <h2 className="text-base sm:text-lg font-semibold text-[#333333]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
            All Transactions
          </h2>
        </div>
            ...
            transactions.map((tx: any) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
                  <div>
                    <p className="font-medium text-sm sm:text-base text-[#333333]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
                      {tx.doctor}
                    </p>
                    <p className="text-xs sm:text-sm text-[#6C7087]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-3 sm:gap-6">
                    <div className="text-left sm:text-right">
                      <p className="text-xs sm:text-sm font-medium text-[#333333]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
                        {tx.date}
                      </p>
                      <p className="text-xs sm:text-sm text-[#001E42] font-semibold" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
