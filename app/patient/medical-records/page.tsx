...
export default function MedicalRecords() {
  ...
  return (
    <div className="space-y-8">
      <section>
        <h2 className="text-base sm:text-lg font-semibold text-[#333333] mb-4" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>Consultation History</h2>
        <div className="bg-white border border-gray-100 divide-y divide-gray-100">
          {encounterLoading ? <LoadingSpinner className="py-8" /> :
           encounters.length === 0 ? <p className="px-4 sm:px-6 py-8 text-center text-[#6C7087]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>No consultation records found</p> :
      ...
      <section>
        <h2 className="text-base sm:text-lg font-semibold text-[#333333] mb-4" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>Prescriptions</h2>
        <div className="bg-white border border-gray-100 divide-y divide-gray-100">
          {encounterLoading ? <LoadingSpinner className="py-8" /> :
           encounters.length === 0 ? <p className="px-4 sm:px-6 py-8 text-center text-[#6C7087]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>No prescriptions found</p> :
           encounters.map((enc: any) => (
      ...
      <section>
        <h2 className="text-base sm:text-lg font-semibold text-[#333333] mb-4" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>Lab Tests</h2>
        <div className="bg-white border border-gray-100 divide-y divide-gray-100">
          {labLoading ? <LoadingSpinner className="py-8" /> :
           labTests.length === 0 ? <p className="px-4 sm:px-6 py-8 text-center text-[#6C7087]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>No lab tests found</p> :
