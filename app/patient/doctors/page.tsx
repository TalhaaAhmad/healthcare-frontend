...
export default function DoctorsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-xl sm:text-2xl font-semibold text-[#333333]" style={{ fontFamily: "var(--font-eb-garamond), 'EB Garamond', Georgia, serif" }}>Our Doctors</h1>
            ...
            <div key={doctor.name} className="bg-white border border-gray-100 overflow-hidden hover:shadow-sm transition-shadow">
              ...
              <div className="px-4 sm:px-6 pb-5 sm:pb-6">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <a href={`/patient/appointments/book?doctor=${encodeURIComponent(doctor.name)}`} className="text-xs sm:text-sm text-[#E500BB] hover:text-[#001E42] font-semibold transition-colors" style={{ fontFamily: "var(--font-open-sans), 'Open Sans', Arial, sans-serif" }}>
                    Book Appointment →
                  </a>
                </div>
              </div>
