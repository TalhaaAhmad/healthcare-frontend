  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F2F8F5] px-4 py-8">
      <div className="max-w-md w-full bg-white border border-gray-100 p-6 sm:p-8 text-center">
        ...
        <h1 className="text-xl sm:text-2xl font-semibold text-[#333333] mb-2" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
          Payment Failed
        </h1>

        <p className="text-sm sm:text-base text-[#666666] mb-2" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
          {decodeURIComponent(reason)}
        </p>

        {code && (
          <p className="text-sm text-[#6C7087] mb-6" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
            Error Code: {code}
          </p>
        )}
        ...
        <p className="mt-6 text-xs text-[#6C7087]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>
    ...
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-[#F2F8F5]">
        <div className="text-center">
          ...
          <p className="text-[#6C7087]" style={{ fontFamily: "var(--font-inter), 'Inter', Arial, sans-serif" }}>Loading...</p>
        </div>
      </div>
    }>
